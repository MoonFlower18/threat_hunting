...
!\[Alt text\](Скриншоты/Свойства собранного трафика.png)\
...
bashdf = pd.read_csv('evil_hosts.data', sep="\\s+", names=\['redirect_to','CNAME'\])bd_domains = df\['CNAME'\]\
\
...
\
!\[alt text\]((Скриншоты/Итог программы.jpg)\

**\## Оценка результата**\
В результате лабораторной работы мы смлогли определить нежелательный трафик.\
